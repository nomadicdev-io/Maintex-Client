...
export default function SearchBar({placeholder, onKeywordSearch, className}) {
  ...
  return (
    <form 
    onSubmit={onSubmit}
    className={cn("relative inline-flex font-medium dark:font-semibold items-center justify-center whitespace-nowrap text-[0.9rem] font-regular transition-all duration-450 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-5 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive overflow-hidden bg-bg border border-text/15 text-text/75 h-10 rounded-lg has-[>svg]:px-3 w-70 bg-bg-300/50", className)}>
        <input 
            type="text"
