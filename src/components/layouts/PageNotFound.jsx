  ...
  return (
    <div className='relative flex-1 flex flex-col w-full h-full p-8 items-center justify-center'>
        ...
        <div className="relative w-full flex flex-col items-center justify-center gap-2 text-center">
            <h2 className='text-2xl font-medium'><span className='text-5xl block mb-3'>So Sorry,</span> <span className='font-regular opacity-75'>we couldn't find the page you're looking for...</span></h2>
