const appConfig = {
  ...
  metadata: {
    title: "PGS iO – The Developer Sandbox",
    description: "PGS iO is the internal developer platform where innovation meets collaboration. Build freely, share fearlessly, and shape the future of code – together.",
    ...
    og: {
      ...
      description: "Explore, experiment, and collaborate in PGS iO — the internal dev sandbox built by and for engineers at PGS."
    },
    twitter: {
      card: "summary_large_image",
      site: "@PGS_Dev", // Optional internal or placeholder handle
      title: "PGS iO – The Developer Sandbox",
      description: "Collaborate, create, and grow inside PGS iO — your private dev playground.",
